...
#define MAX_SKILL_POINT_LEVEL 60
//职业列表
#define JOB_TYPE_SECTION                @[@"职业"]
#define JOB_TYPE_NAME                   @[@[@"战士", @"魔法师", @"僧侣", @"武术家", @"旅行艺人", @"寻宝家", @"圣骑士", @"游侠", @"魔法战士", @"贤者", @"战斗大师"]]
...
//技能列表
#define SKILL_DETAIL_SECTION            @[@"勇敢", @"魔法", @"信仰", @"气力", @"曲艺", @"宝物", @"博爱", @"生存", @"源力", @"悟性", @"单手剑", @"双手剑", @"短剑", @"短杖", @"双手杖", @"矛", @"棍", @"爪", @"鞭", @"斧", @"扇", @"弓", @"锤", @"回旋镖", @"盾", @"格斗", @"斗魂"]
