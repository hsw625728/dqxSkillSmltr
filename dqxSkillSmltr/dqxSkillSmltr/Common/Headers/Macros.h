...
#define JOB_SKILL_TYPE_ZD [[DSGlobalJobInfo alloc] \
initMine:@"战斗大师" \
level:10 \
sJob:@"斗魂" \
weapon1:@"单手剑" \
...
#define JOB_SKILL_TYPE_MX [[DSGlobalJobInfo alloc] \
initMine:@"超级明星" \
level:10 \
sJob:@"星光" \
weapon1:@"鞭" \
...
#define MAX_SKILL_POINT_LEVEL 70
//职业列表
#define JOB_TYPE_SECTION                @[@"职业"]
#define JOB_TYPE_NAME                   @[@[@"战士", @"魔法师", @"僧侣", @"武术家", @"旅行艺人", @"寻宝家", @"圣骑士", @"游侠", @"魔法战士", @"贤者", @"战斗大师", @"超级明星"]]
...
//技能列表
#define SKILL_DETAIL_SECTION            @[@"勇敢", @"魔法", @"信仰", @"气力", @"曲艺", @"宝物", @"博爱", @"生存", @"源力", @"悟性", @"单手剑", @"双手剑", @"短剑", @"短杖", @"双手杖", @"矛", @"棍", @"爪", @"鞭", @"斧", @"扇", @"弓", @"锤", @"回旋镖", @"盾", @"格斗", @"斗魂", @"星光"]
...
@[@"对目标造成1.5倍伤害，25%几率斗志上升一段，攻击后斗志消失",\
@"所有职业灵巧+20",\
@"所有职业力量+5",\
@"自身攻击力上升2段，防御力降低1段",\
@"所有职业敏捷+30",\
@"对目标造成1.5倍伤害，所造成伤害的25%反伤给自己",\
@"所有职业力量+5",\
@"对目标造成1.5倍伤害，射程中等",\
@"所有职业力量+5",\
@"对目标造成0.5倍 X 6回伤害"],\
@[@"付纸笺钱签名攻击一个敌人",\
@"所有职业魅力+20",\
@"使周围敌人失明，附加幻觉状态，成功率与时尚度有关",\
@"所有职业敏捷+30",\
@"使周围的敌人容易入迷",\
@"所有职业攻击魔力+10",\
@"使用金币雇佣保镖保护自己，当受到伤害时保镖代为承受伤害，保镖的防御为200点，黑色服装保镖的HP量与使用者相同，白色服装为双倍，金色服装为四倍",\
@"所有职业魅力+60",\
@"战斗后获得经验与金币提升为1.1~1.5倍",\
@"对范围内敌人造成300点左右的伤害"]]
